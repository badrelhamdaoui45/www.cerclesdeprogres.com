/* compact [
	prive/javascript/jquery.js?1583613873
	prive/javascript/jquery-migrate-3.0.1.js?1583613873
	prive/javascript/jquery.form.js?1583613873
	prive/javascript/jquery.autosave.js?1583613873
	prive/javascript/jquery.placeholder-label.js?1583613873
	prive/javascript/ajaxCallback.js?1583613873
	prive/javascript/js.cookie.js?1583613873
	prive/javascript/jquery.cookie.js?1583613873
	plugins-dist/mediabox/javascript/jquery.colorbox.js?1583613889
	plugins-dist/mediabox/javascript/spip.mediabox.js?1583613889
	plugins-dist/porte_plume/javascript/jquery.markitup_pour_spip.js?1583613883
	plugins-dist/porte_plume/javascript/jquery.previsu_spip.js?1583613883
	local/cache-js/jsdyn-javascript_porte_plume_start_js-9bbf910a.js?1709196634
	plugins/auto/inserer_modeles/v1.3.5/javascript/autosize.min.js
] 58.6% */
...
,{"name":"Insérer un modèle","key":"M","className":"outil_inserer_modeles separateur separateur_apres sepInsMod","beforeInsert":function(){jQuery.modalboxload('https://www.cerclesdeprogres.com/spip.php?page=inserer_modeles&modalbox=oui&id_article='+$("[name='id_article']").val()+'&id_rubrique='+$("[name='id_rubrique']").val()+'&id_breve='+$("[name='id_breve']").val(),{minHeight:'90%'});},"dropMenu":[{"id":"inserer_modele_formulaire_contact","name":"le formulaire de contact avancé","className":"outil_inserer_modele_formulaire_contact","beforeInsert":function(){jQuery.modalboxload('https://www.cerclesdeprogres.com/spip.php?page=inserer_modeles&modalbox=oui&formulaire_modele=formulaire_contact&id_article='+$("[name='id_article']").val()+'&id_rubrique='+$("[name='id_rubrique']").val()+'&id_breve='+$("[name='id_breve']").val(),{minHeight:'90%'});},"display":true}
,{"id":"inserer_modele_media","name":"un document","className":"outil_inserer_modele_media","beforeInsert":function(){jQuery.modalboxload('https://www.cerclesdeprogres.com/spip.php?page=inserer_modeles&modalbox=oui&formulaire_modele=media&id_article='+$("[name='id_article']").val()+'&id_rubrique='+$("[name='id_rubrique']").val()+'&id_breve='+$("[name='id_breve']").val(),{minHeight:'90%'});},"display":true}
]
}
...
,{"name":"Insérer un filet de séparation","className":"cs_filets_drop separateur separateur_apres sepCaracteres","replaceWith":"","dropMenu":[{"id":"filet_0","name":"Insérer un filet de style « 0 »","className":"filet_0","replaceWith":"\n__0__\n","display":true}
,{"id":"filet_1","name":"Insérer un filet de style « 1 »","className":"filet_1","replaceWith":"\n__1__\n","display":true}
,{"id":"filet_2","name":"Insérer un filet de style « 2 »","className":"filet_2","replaceWith":"\n__2__\n","display":true}
,{"id":"filet_3","name":"Insérer un filet de style « 3 »","className":"filet_3","replaceWith":"\n__3__\n","display":true}
,{"id":"filet_4","name":"Insérer un filet de style « 4 »","className":"filet_4","replaceWith":"\n__4__\n","display":true}
